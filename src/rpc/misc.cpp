...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)luxDGP.getBlockSize(chainActive.Height()));
    obj.pushKV("mingasprice", (uint64_t)luxDGP.getMinGasPrice(chainActive.Height()));
    obj.pushKV("blockgaslimit", (uint64_t)luxDGP.getBlockGasLimit(chainActive.Height()));
