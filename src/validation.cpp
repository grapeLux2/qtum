...
std::vector<ResultExecute> CallContract(const dev::Address& addrContract, std::vector<unsigned char> opcode, const dev::Address& sender, uint64_t gasLimit){
    ...
    ByteCodeExec exec(block, std::vector<LuxTransaction>(1, callTransaction), blockGasLimit, pblockindex);
...
///////////////////////////////////////////////////////////////////////////////////////// lux
        ...
        if(tx.HasCreateOrCall() && !hasOpSpend){
            ...
            dev::u256 gasAllTxs = dev::u256(0);
            ByteCodeExec exec(block, resultConvertLuxTX.first, blockGasLimit, pindex->pprev);
            ...
            for(LuxTransaction& qtx : resultConvertLuxTX.first){
...
//////////////////////////////////////////////////////////////////////////
    ...
    for (pindex = chainActive.Tip(); pindex && pindex->pprev; pindex = pindex->pprev) {
        ...
        ///////////////////////////////////////////////////////////////////// // lux
        uint32_t sizeBlockDGP = luxDGP.getBlockSize(pindex->nHeight);
        dgpMaxBlockSize = sizeBlockDGP ? sizeBlockDGP : dgpMaxBlockSize;
        updateBlockSizeParams(dgpMaxBlockSize);
        /////////////////////////////////////////////////////////////////////
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // But for Lux PoS we need to sync this after every block to ensure txdb is populated for
