#ifndef LUXVERSIONCHECKER_H
#define LUXVERSIONCHECKER_H

#include <QObject>

#define LUX_RELEASES "https://github.com/luxproject/lux/releases"
...
class LuxVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit LuxVersionChecker(QObject *parent = 0);
    ~LuxVersionChecker();
