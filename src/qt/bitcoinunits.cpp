...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Luxs");
    case mBTC: return QString("Milli-Luxs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Luxs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
